...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection platform_order_number
     ...
     * @method Grid\Column|Collection platform_order_number(string $label = null)
     ...
     * @property Show\Field|Collection platform_order_number
     ...
     * @method Show\Field|Collection platform_order_number(string $label = null)
