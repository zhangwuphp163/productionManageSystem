    ...
    protected function grid()
    {
        return Grid::make(new StoreSku(['store','product']), function (Grid $grid) {
            ...
            $grid->tools(function (Grid\Tools $tools) {
                $tools->append('<a href="javascript:void(0);" class="btn btn-primary batch-print" data-title="批量打印条码" data-type="barcode">&nbsp;&nbsp;&nbsp;<i class="fa fa-print"></i> 批量打印条码&nbsp;&nbsp;&nbsp;</a>');
                $tools->append('<a href="javascript:void(0);" class="btn btn-primary batch-print" data-title="批量打印装箱码" data-type="box">&nbsp;&nbsp;&nbsp;<i class="fa fa-inbox"></i> 批量打印装箱码&nbsp;&nbsp;&nbsp;</a>');
            });
            $grid->scrollbarX();
