...
class NewOrderLabel
{
    ...
    function generate() {
        ...
        $orders = NewOrder::query()->whereIn('id', $this->ids)->get();
    ...
    public function setContents(\TCPDF &$pdf,NewOrder $order)
    {
        ...
        $pdf->writeHTMLCell(75,15,45,5,$order->delivery_deadline,0,0,false,true,"C");
        $pdf->writeHTMLCell(75,15,45,20,$order->platform_number,0,0,false,true,"C");
        ...
        $pdf->write2DBarcode(asset("mobile/order?order_number={$order->platform_number}"), 'QRCODE,M', 150, 100, 30, 30, $barcode_style, 'L');
