...
return  '<div class="vs-checkbox-con vs-checkbox-primary checkbox-grid checkbox-grid-column">
    ...
    <span class="vs-checkbox"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span>
        ...
        $grid->tools(function (Grid\Tools $tools) {
            $tools->append('<a href="javascript:void(0);" class="btn btn-primary batch-print" data-batch-type="inbound" data-title="批量打印条码‘ ijokpl xcvb   vcvdbnfghb/.  ">&nbsp;&nbsp;&nbsp;<i class="fa fa-print"></i> 批量打印条码&nbsp;&nbsp;&nbsp;</a>');
            $tools->append('<a href="javascript:void(0);" class="btn btn-primary batch-edit" data-batch-type="inbound" data-title="批量入库操作">&nbsp;&nbsp;&nbsp;<i class="fa fa-opera"></i> 批量入库操作&nbsp;&nbsp;&nbsp;</a>');
            $tools->append('<a href="javascript:void(0);" class="btn btn-danger batch-edit" data-batch-type="outbound" data-title="批量出库操作">&nbsp;&nbsp;&nbsp;<i class="fa fa-inbox"></i> 批量出库操作&nbsp;&nbsp;&nbsp;</a>');
        });
