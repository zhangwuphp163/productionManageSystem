...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('status')->index()->default('sale')->nullable();
            ...
            $table->decimal('inner_box_length',6,1)->nullable();
            $table->decimal('inner_box_width',6,1)->nullable();
            $table->decimal('inner_box_height',6,1)->nullable();
            $table->decimal('inner_box_gross_weight',8,3)->nullable();
            $table->integer('inner_box_packing_qty')->nullable();
            $table->decimal('outer_box_length',6,1)->nullable();
            $table->decimal('outer_box_width',6,1)->nullable();
            $table->decimal('outer_box_height',6,1)->nullable();
